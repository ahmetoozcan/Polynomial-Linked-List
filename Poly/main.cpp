...
void Test3()
{
	...
	printf("%25s", "Poly2[-x^2+x-5]: ");
	Print(poly2);

	PolyNode *poly3 = Add(poly1, poly2);
	printf("--------------------------------------------------- +\n");
	printf("%25s", "Poly1+Poly2: ");
	Print(poly3);
...
void Test6()
{
	...
	PolyNode *poly = CreatePoly((char *)"-x^3  -  6x^2 + 4x + 22");
	printf("%25s", "Poly[-x^3-6x^2+ 4x+22]: ");
	Print(poly);
...
void Test7()
{
	...
	printf("%25s", "Deriv[-x^3-6x^2+ 4x+22]: ");
	Print(deriv);
} // end-Test7
